// Создание кода T4 для модели "C:\Учеба 2\Инструментальные средства разработки программного обеспечения\Попрыженок - агенты\app_poprizonok\app_poprizonok\Entity\poprizonok_DB.edmx" включено. 
